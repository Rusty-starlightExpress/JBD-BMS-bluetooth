...
def cellvolts2(data):			# process cell voltages
    ...
    message = ("meter,cell9,cell10,cell11,cell12,cell13,cell14\r\n%s,%0i,%0i,%0i,%0i,%0i,%0i" % (meter,cell9,cell10,cell11,cell12,cell13,cell14))
    #reporter.send_data(message)  
    print(message)
    cells2 = [cell9, cell10, cell11, cell12, cell13, cell14]	# adding cells min, max and delta	
...
class MyDelegate(DefaultDelegate):		# handles notification responses
	...
	def handleNotification(self, cHandle, data):
		...
		if text_string.find('dd04') != -1:		# check incoming data for routing to decoding routines
			...
			cellinfo1(data)
		elif text_string.find('77') != -1 and len(text_string) == 30:	 # x04
			cellvolts2(data)
